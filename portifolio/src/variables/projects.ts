export const projetos = [
    {
        id:1,
        titulo:'Byte & Bite',
        imgSrc: 'https://github.com/JoaoLucasLourenco/Portifolio/blob/main/byte-bite.png?raw=true',
        textoDescritivo:'Web app completo com Frontend e Backend, para servir como prontuário'+
